  ...
  return (
    <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
      ...
      <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
        <span className="py-2 px-4">{children}</span>
...
export function AnimatedButton({ children }: { children: ReactNode }) {
  return (
    <button className="relative inline-flex h-10 w-5/6 md:w-1/4 font-bold group/arrow overflow-hidden rounded-sm p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
